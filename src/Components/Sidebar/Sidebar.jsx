import Multilanguage from 'Pages/Multilanguage/MultiLanguage';
      ...
      <div className="main-container vh-100">
        ...
        >
          <div className="top_section">
            ...
            <div className="bars">
              <FaBars onClick={toggle} className="pointer open-close" />
            </div>
          </div>
          {isOpen && (
            <>
        ...
        <main
          // className={`w-100  ${
          //   pathname === '/manage-work-permit/new' || pathname === '/manage-work-permit/:id'
          //     ? 'overflow-hidden'
          //     : 'overflow-hidden'
          // }`}
          className={`w-100 ${
            pathname.startsWith('/print/') ? 'overflow-hidden_no' : 'overflow-hidden'
          }`}
        >
          {children}
        </main>
