...
<main style="padding:0px 10px;">
  <table class="section1" style="border: 1px solid #000 !important;width: 100%;border-top:none!important;">
    <tbody>
     
      <tr style="background: #fff;border: 1px solid #000;border-top:none!important;">
      ...
      <tr style="background: #ccffcc;">
          ...
          <table class="w-100">
            <tbody>
              <tr>
                ...
                <td style="width: 25%;border-left: none!important;">
                  <div style="display: flex;align-items: center; position: relative;">
              ...
              <tr>
                ...
                <td colspan="2">
                  <div class="inline-flex">
                    <p style="font-size: 10px;font-weight: 500;margin: 0;padding-left: 10px;">until Hours: {{extraDetails.validTo.time}} </p>
                  </div>
                </td>
              </tr>
            </tbody>
        ...
        <td style="width: 25%;border-left:none!important;border-bottom: 1px solid #000;">
          <div>
            <div class="inline-flex">
              <p style="font-size: 10px;font-weight: 500;margin: 0;padding-left:10px;">No. Register: {{extraDetails.number}}</p>
            </div>
          </div>
          <div>
            <div class="inline-flex">
              <p style="font-size: 10px;font-weight: 500;margin: 0;padding-left:10px;">Date: {{extraDetails.date}} </p>
            </div>
          </div>
          <div>
            <div class="inline-flex">
              <p style="font-size: 10px;font-weight: 500;margin: 0;padding-left:10px;">Work Orders: {{extraDetails.workOrder}}</p>
            </div>
          </div>
          <div>
            <div class="inline-flex">
              <p style="font-size: 10px;font-weight: 500;margin: 0;padding-left:10px;">Tag Number: {{JobApplication.mainTag1}} </p>
            </div>
          </div>
        </td>
      </tr>
      <tr style="background: #ccffcc;border-bottom: 1px solid #000;">
        ...
        <td style="padding: 0.5rem;">
          <div class="inline-flex">
            <p style="font-size: 10px;font-weight: 500;margin: 0;">Tag Description: {{JobApplication.tagNumber}} </p>
          </div>
        </td>
      </tr>
      <tr style="background: #ccffcc;border-bottom: 1px solid #000;">
    ...
    <tbody>
      <tr style="background: #ccffcc;border-bottom: 1px solid #000;">
        <td colspan="2" style="width: 70%;padding: 0.5rem;">
          <div class="inline-flex">
            <p style="font-size: 10px;font-weight: 500;margin: 0;">SPB/ SPK Number (If required): {{JobApplication.spbSpkNumber1}} </p>
          </div>
        </td>
        <td class="bor" style="width: 30%;border-left: 1px solid #000;padding: 0.5rem;">
          <div class="inline-flex">
            <p style="font-size: 10px;font-weight: 500;margin: 0;">Duration/ Length of Work (Days): {{JobApplication.durationLengthOfWork
            }} &nbsp;</p>
          </div>
        </td>
      </tr>
      <tr style="background: #ccffcc;border-bottom: 1px solid #000;">
          ...
          <table style="width: 100%;">
            <tbody>
              <tr>
                <td style="width: 60%">
                  <div class="inline-flex">
                    <p style="font-size: 10px;font-weight: 500;margin: 0;padding-left: 10px;">Work Executor: {{JobApplication.textField}}
                    </p>
                  </div>
                </td>
                <td style="width: 20%">
        ...
        <td style="width: 30%;padding: 0.5rem;">
          <div class="inline-flex">
            <p style="font-size: 10px;font-weight: 500;margin: 0;">No of Manpower: {{JobApplication.totalManPower}} &nbsp; </p>
          </div>
        </td>
      </tr>
    </tbody>
  ...
  <table style="border: 1px solid #000;border-top: none;width: 100%;border-bottom:none;">
    <tbody>
      ...
      <tr style="background: #ccffcc;">
        <td style="width: 25%">
          <div style="display: flex;align-items: center; position: relative;">
            ...
            <label class="form-check-label"><p style="font-size: 10px;font-weight: 500;margin: 0;">Arc Welding</p></label>
          </div>
          <div style="display: flex;align-items: center; position: relative;">
            ...
            <label class="form-check-label"><p style="font-size: 10px;font-weight: 500;margin: 0;">Gas Welding/ Cutting</p></label>
          </div>
          <div style="display: flex;align-items: center; position: relative;">
            ...
            <label class="form-check-label"><p style="font-size: 10px;font-weight: 500;margin: 0;">Portable Electrical Equipment</p></label>
          </div>
          <div style="display: flex;align-items: center; position: relative;">
            ...
            <label class="form-check-label"><p style="font-size: 10px;font-weight: 500;margin: 0;">Grinder</p></label>
          </div>
          <div style="display: flex;align-items: center; position: relative;">
            ...
            <label class="form-check-label"><p style="font-size: 10px;font-weight: 500;margin: 0;">Electric Drill</p></label>
          </div>
          <div style="display: flex;align-items: center; position: relative;">
          <input disabled={true} style="margin: 5px 10px !important;" {% if tools.poorLighting %} checked {% endif %} class="form-check-input" type="checkbox" id="electricDrill" name="electricDrill" value="something" >
          <label class="form-check-label"><p style="font-size: 10px;font-weight: 500;margin: 0;">Poor Lighting</p></label>
        </div>
        <div style="display: flex;align-items: center; position: relative;">
        <input disabled={true} style="margin: 5px 10px !important;" {% if tools.unguardedOpening %} checked {% endif %} class="form-check-input" type="checkbox" id="electricDrill" name="electricDrill" value="something" >
        ...
        <td style="width: 25%">
          <div style="display: flex;align-items: center; position: relative;">
            ...
            <label class="form-check-label"><p style="font-size: 10px;font-weight: 500;margin: 0;">Mobile Internal Combustion Equip't</p></label>
          </div>
          <div style="display: flex;align-items: center; position: relative;">
            ...
            <label class="form-check-label"><p style="font-size: 10px;font-weight: 500;margin: 0;">Motorized Access Platform</p></label>
          </div>
          <div style="display: flex;align-items: center; position: relative;">
            ...
            <label class="form-check-label"><p style="font-size: 10px;font-weight: 500;margin: 0;">Mobile Crane</p></label>
          </div>
          <div style="display: flex;align-items: center; position: relative;">
            ...
            <label class="form-check-label"><p style="font-size: 10px;font-weight: 500;margin: 0;">Excavator</p></label>
          </div>
          <div style="display: flex;align-items: center; position: relative;">
          ...
          <div style="display: flex;align-items: center; position: relative;">
          <input disabled={true} style="margin: 5px 10px !important;" {% if tools.chemicals %} checked {% endif %} class="form-check-input" type="checkbox" id="liftingEquipment" name="liftingEquipment" value="something" >
          <label class="form-check-label"><p style="font-size: 10px;font-weight: 500;margin: 0;">Chemicals</p></label>
        </div>
        <div style="display: flex;align-items: center; position: relative;">
        <input disabled={true} style="margin: 5px 10px !important;" {% if tools.h2S %} checked {% endif %} class="form-check-input" type="checkbox" id="liftingEquipment" name="liftingEquipment" value="something" >
        ...
        <td style="width: 25%">
          ...
          <div style="display: flex;align-items: center; position: relative;">
            <input disabled={true} style="margin: 5px 10px !important;" {% if tools.kekuranganOksigen %} checked {% endif %}  class="form-check-input" type="checkbox" id="radioactiveSource" name="radioactiveSource" value="something" >
          ...
          <div style="display: flex;align-items: center; position: relative;">
          <input disabled={true} style="margin: 5px 10px !important;" {% if tools.liveEquipment %} checked {% endif %} class="form-check-input" type="checkbox" id="electricalConverter" name="electricalConverter" value="something" >
        ...
        <td style="width: 25%">
          <div style="display: flex;align-items: center; position: relative;">
            ...
            <label class="form-check-label"><p style="font-size: 10px;font-weight: 500;margin: 0;">Chain Hoise</p></label>
          </div>
          <div style="display: flex;align-items: center; position: relative;">
            ...
            <label class="form-check-label"><p style="font-size: 10px;font-weight: 500;margin: 0;">Flange Spider</p></label>
          </div>
          <div style="display: flex;align-items: center; position: relative;">
            <input disabled={true} style="margin: 5px 10px !important;" {% if tools.terpaparMaterialYangBeterbangan %} checked {% endif %} class="form-check-input" type="checkbox" id="tourcheWrench" name="tourcheWrench" value="something" >
            <label class="form-check-label"><p style="font-size: 10px;font-weight: 500;margin: 0;">Tourche Wrench</p></label>
          </div>
          <div style="display: flex;align-items: center; position: relative;">
            ...
            <label class="form-check-label"><p style="font-size: 10px;font-weight: 500;margin: 0;">Jack Hammer</p></label>
          </div>
          <div style="display: flex;align-items: center; position: relative;">
            <input disabled={true} style="margin: 5px 10px !important;" {% if tools.terpaparMaterialYangBeterbangan %} checked {% endif %}  class="form-check-input" type="checkbox" id="keyTools" name="keyTools" value="something" >
            <label class="form-check-label"><p style="font-size: 10px;font-weight: 500;margin: 0;">Key Tools</p></label>
          </div>
          <div style="display: flex;align-items: center; position: relative;">
          <input disabled={true} style="margin: 5px 10px !important;" {% if tools.extremeWeather %} checked {% endif %}  class="form-check-input" type="checkbox" id="keyTools" name="keyTools" value="something" >
      ...
      <tr style="background: #ccffcc;">
        <td style="width: 25%">
          ...
          <div style="display: flex;align-items: center; position: relative;">
            <input disabled={true} style="margin: 5px 10px !important;" {% if IdentifyPotential.kekuranganOksigen %} checked {% endif %}  class="form-check-input" type="checkbox" id="liquidGasUnderPressure" name="liquidGasUnderPressure" value="something" >
        ...
        <td style="width: 25%">
          ...
          <div style="display: flex;align-items: center; position: relative;">
            ...
            <label class="form-check-label"><p style="font-size: 10px;font-weight: 500;margin: 0;">Simultaneous Operation</p></label>
          </div>
          <div style="display: flex;align-items: center; position: relative;">
        ...
        <td style="width: 25%">
          <div style="display: flex;align-items: center; position: relative;">
            <input disabled={true} style="margin: 5px 10px !important;" {% if IdentifyPotential.terpaparRadioactive %} checked {% endif %}   class="form-check-input" type="checkbox" id="electricShock" name="electricShock" value="something" >
          ...
          <div style="display: flex;align-items: center; position: relative;">
            ...
            <label class="form-check-label"><p style="font-size: 10px;font-weight: 500;margin: 0;">Moving Machinary </p></label>
          </div>
          <div style="display: flex;align-items: center; position: relative;">
          ...
          <div style="display: flex;align-items: center; position: relative;">
            ...
            <label class="form-check-label"><p style="font-size: 10px;font-weight: 500;margin: 0;">Danger Of Dropped Objects</p></label>
          </div>
        </td>
        <td style="width: 25%">
          <div style="display: flex;align-items: center; position: relative;">
          ...
          <div style="display: flex;align-items: center; position: relative;">
            ...
            <label class="form-check-label"><p style="font-size: 10px;font-weight: 500;margin: 0;">Slippery Hazard</p></label>
          </div>
        </td>
      </tr>
      <tr style="border-top: 1px solid #000;border-bottom: 1px solid #000;">
    ...
    <tbody>
      <tr style="background: #ccffcc;border-bottom: 1px solid #000;">
        ...
        <td>
          ...
          <div style="display: flex;align-items: center; position: relative;margin-left: 10px;margin-top: 4px;">
                    <p style="font-size: 10px;font-weight: 500;margin: 0;">Others: {{PersonalProtective.number}}
  ...
  <table style="border: 1px solid #000;border-top: none;width: 100%;" class="section2">
    <tbody>
      <tr style="border-bottom: 1px solid #000;">
        <td colspan="3" style="padding: 0 0.5rem;">
          <p style="margin: 0;font-size: 12px;"><b>Section 2: Safety Requirements (To Be Completed By Area Athurity (GSI))</b></p>
        </td>
      </tr>
        ...
        <tbody>
          <tr style="border-bottom: 1px solid #000;">
            <td style="width: 90%;text-align: center;">
              <p style="font-size: 10px;font-weight: 600;">Supplementary Required Documents</p>
          ...
          <tr style="border-bottom: 1px solid #000;">
                ...
                <tbody>
                  <tr>
                    ...
                    <td style="width: 30%;background: #fff;border-left: 1px solid #000;">
                      <p disabled={true} style="height: 23px !important;margin: inherit !important;border-color: transparent !important;" type="text" class="form-control" id="safetyRequirement2" placeholder="" name="safetyRequirement2" style="height: auto;margin: inherit;padding: 0.175rem 0.75rem;">{{MarkAnyDocumentsRequired.textField}}</p>
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <td style="text-align: center;border-left: 1px solid #000;">
              <div>
              <input  disabled={true} style="margin: 0 !important;" {% if MarkAnyDocumentsRequired.SikaEntersConfinedSpace %} checked {% endif %}  class="form-check-input" type="checkbox" id="MarkAnyDocumentsRequired" name="MarkAnyDocumentsRequired" value="something" >
              </div>
            </td>
          ...
          <tr style="border-bottom: 1px solid #000;">
              ...
              <table style="width: 100%;">
                <tbody>
                  <tr>
                    ...
                    <td style="width: 30%;background: #fff;border-left: 1px solid #000;">
                      <p disabled={true} style="height: 23px !important;margin: inherit !important;border-color: transparent !important;" type="text" class="form-control" id="safetyRequirement2" placeholder="" name="safetyRequirement2" style="height: auto;margin: inherit;padding: 0.175rem 0.75rem;" >{{MarkAnyDocumentsRequired.textField1}}</p>
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <td style="text-align: center;border-left: 1px solid #000;">
              <div>
              <input  disabled={true} style="margin: 0 !important;" {% if MarkAnyDocumentsRequired.SikaElectricalInstrument %} checked {% endif %}  class="form-check-input" type="checkbox" id="MarkAnyDocumentsRequired" name="MarkAnyDocumentsRequired" value="something" >
          ...
          <tr style="border-bottom: 1px solid #000;">
              ...
              <table style="width: 100%;">
                <tbody>
                  <tr>
                    ...
                    <td style="width: 30%;background: #fff;border-left: 1px solid #000;">
                    <p disabled={true} style="height: 23px !important;margin: inherit !important;border-color: transparent !important;" type="text" class="form-control" id="safetyRequirement2" placeholder="" name="safetyRequirement2" style="height: auto;margin: inherit;padding: 0.175rem 0.75rem;" >{{MarkAnyDocumentsRequired.textField2}}</p>
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <td style="text-align: center;border-left: 1px solid #000;">
              <div>
              <input  disabled={true} style="margin: 0 !important;" {% if MarkAnyDocumentsRequired.SikaExcavation %} checked {% endif %}  class="form-check-input" type="checkbox" id="MarkAnyDocumentsRequired" name="MarkAnyDocumentsRequired" value="something" >
              </div>
            </td>
          ...
          <tr style="border-bottom: 1px solid #000;">
            <td style="padding: 0px;">
              <table style="width: 100%;">
                <tbody>
                  <tr>
                    <td style="width: 70%;">
                      <p style="font-size: 10px;font-weight: 500;">4. SIKA/ PTW Vehicle Entery/ Access </p>
                    </td>
                    <td style="width: 30%;background: #fff;border-left: 1px solid #000;">
                    <p disabled={true} style="height: 23px !important;margin: inherit !important;border-color: transparent !important;" type="text"  class="form-control" id="safetyRequirement2" placeholder="" name="safetyRequirement2" style="height: auto;margin: inherit;padding: 0.175rem 0.75rem;" >{{MarkAnyDocumentsRequired.textField3}}</p></td>
                  </tr>
                </tbody>
              </table>
            </td>
            <td style="text-align: center;border-left: 1px solid #000;">
              <div>
              <input  disabled={true} style="margin: 0 !important;" {% if MarkAnyDocumentsRequired.SikaHeavyEquipmentMovement %} checked {% endif %}  class="form-check-input" type="checkbox" id="MarkAnyDocumentsRequired" name="MarkAnyDocumentsRequired" value="something" >
              </div>
            </td>
          ...
          <tr style="border-bottom: 1px solid #000;">
              ...
              <table style="width: 100%;">
                <tbody>
                  <tr>
                    ...
                    <td style="width: 30%;background: #fff;border-left: 1px solid #000;">
                    <p disabled={true} style="height: 23px !important;margin: inherit !important;border-color: transparent !important;" type="text"  class="form-control" id="safetyRequirement2" placeholder="" name="safetyRequirement2" style="height: auto;margin: inherit;padding: 0.175rem 0.75rem;" >{{MarkAnyDocumentsRequired.textField4}}</p></td>
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <td style="text-align: center;border-left: 1px solid #000;">
              <div>
              <input  disabled={true} style="margin: 0 !important;" {% if MarkAnyDocumentsRequired.SikaRadiation %} checked {% endif %}  class="form-check-input" type="checkbox" id="MarkAnyDocumentsRequired" name="MarkAnyDocumentsRequired" value="something" >
              </div>
            </td>
          ...
          <tr style="border-bottom: 1px solid #000;">
              ...
              <table style="width: 100%;">
                <tbody>
                  <tr>
                    ...
                    <td style="width: 30%;background: #fff;border-left: 1px solid #000;">
                    <p disabled={true} style="height: 23px !important;margin: inherit !important;border-color: transparent !important;" type="text"  class="form-control" id="safetyRequirement2" placeholder="" name="safetyRequirement2" style="height: auto;margin: inherit;padding: 0.175rem 0.75rem;" >{{MarkAnyDocumentsRequired.textField5}}</p></td>
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <td style="text-align: center;border-left: 1px solid #000;">
              <div>
              <input  disabled={true} style="margin: 0 !important;" {% if MarkAnyDocumentsRequired.SikaDisablingVitalSecuritySystem %} checked {% endif %}  class="form-check-input" type="checkbox" id="MarkAnyDocumentsRequired" name="MarkAnyDocumentsRequired" value="something" >
              </div>
            </td>
          ...
          <tr style="border-bottom: 1px solid #000;">
              ...
              <table style="width: 100%;">
                <tbody>
                  <tr>
                    ...
                    <td style="width: 30%;background: #fff;border-left: 1px solid #000;">
                    <p disabled={true} style="height: 23px !important;margin: inherit !important;border-color: transparent !important;" type="text"  class="form-control" id="safetyRequirement2" placeholder="" name="safetyRequirement2" style="height: auto;margin: inherit;padding: 0.175rem 0.75rem;" >{{MarkAnyDocumentsRequired.textField6}}</p></td>
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <td style="text-align: center;border-left: 1px solid #000;">
              <div>
              <input  disabled={true} style="margin: 0 !important;" {% if MarkAnyDocumentsRequired.SikaRoadClosure %} checked {% endif %}  class="form-check-input" type="checkbox" id="MarkAnyDocumentsRequired" name="MarkAnyDocumentsRequired" value="something" >
              </div>
            </td>
          ...
          <tr style="border-bottom: 1px solid #000;">
              ...
              <table style="width: 100%;">
                <tbody>
                  <tr>
                    ...
                    <td style="width: 30%;background: #fff;border-left: 1px solid #000;">
                    <p disabled={true} style="height: 23px !important;margin: inherit !important;border-color: transparent !important;" type="text"  class="form-control" id="safetyRequirement2" placeholder="" name="safetyRequirement2" style="height: auto;margin: inherit;padding: 0.175rem 0.75rem;" >{{MarkAnyDocumentsRequired.textField7}}</p></td>
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <td style="text-align: center;border-left: 1px solid #000;">
              <div>
              <input  disabled={true} style="margin: 0 !important;" {% if MarkAnyDocumentsRequired.SikaUnderwater %} checked {% endif %}  class="form-check-input" type="checkbox" id="MarkAnyDocumentsRequired" name="MarkAnyDocumentsRequired" value="something" >
              </div>
            </td>
          ...
          <tr style="border-bottom: 1px solid #000;">
              ...
              <table style="width: 100%;">
                <tbody>
                  <tr>
                    ...
                    <td style="width: 30%;background: #fff;border-left: 1px solid #000;">
                    <p disabled={true} style="height: 23px !important;margin: inherit !important;border-color: transparent !important;" type="text"  class="form-control" id="safetyRequirement2" placeholder="" name="safetyRequirement2" style="height: auto;margin: inherit;padding: 0.175rem 0.75rem;" >{{MarkAnyDocumentsRequired.textField8}}</p></td>
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <td style="text-align: center;border-left: 1px solid #000;">
              <div>
              <input  disabled={true} style="margin: 0 !important;" {% if MarkAnyDocumentsRequired.SikaTheUseOfElectricalVoltageAbove50VoltsInAConfinedSpace %} checked {% endif %}  class="form-check-input" type="checkbox" id="MarkAnyDocumentsRequired" name="MarkAnyDocumentsRequired" value="something" >
          ...
          <tr style="border-bottom: 1px solid #000;">
              ...
              <table style="width: 100%;">
                <tbody>
                  <tr>
                    ...
                    <td style="width: 30%;background: #fff;border-left: 1px solid #000;">
                    <p disabled={true} style="height: 23px !important;margin: inherit !important;border-color: transparent !important;" type="text"  class="form-control" id="safetyRequirement2" placeholder="" name="safetyRequirement2" style="height: auto;margin: inherit;padding: 0.175rem 0.75rem;">{{MarkAnyDocumentsRequired.textField11}}</p></td>
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <td style="text-align: center;border-left: 1px solid #000;">
              <div>
              <input  disabled={true} style="margin: 0 !important;" {% if MarkAnyDocumentsRequired.WorkProcedureSop %} checked {% endif %}  class="form-check-input" type="checkbox" id="MarkAnyDocumentsRequired" name="MarkAnyDocumentsRequired" value="something" >
              </div>
            </td>
          ...
          <tr style="border-bottom: 1px solid #000;">
              ...
              <table style="width: 100%;">
                <tbody>
                  <tr>
                    ...
                    <td style="width: 30%;background: #fff;border-left: 1px solid #000;">
                    <p disabled={true} style="height: 23px !important;margin: inherit !important;border-color: transparent !important;" type="text"  class="form-control" id="safetyRequirement2" placeholder="" name="safetyRequirement2" style="height: auto;margin: inherit;padding: 0.175rem 0.75rem;" >{{MarkAnyDocumentsRequired.textField12}}</p></td>
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <td style="text-align: center;border-left: 1px solid #000;">
              <div>
              <input  disabled={true} style="margin: 0 !important;" {% if MarkAnyDocumentsRequired.EquipmentInspectionWeldingCuttingToolsToolsEtc %} checked {% endif %}  class="form-check-input" type="checkbox" id="MarkAnyDocumentsRequired" name="MarkAnyDocumentsRequired" value="something" >
              </div>
            </td>
          ...
          <tr style="border-bottom: 1px solid #000;">
              ...
              <table style="width: 100%;">
                <tbody>
                  <tr>
                    ...
                    <td style="width: 30%;background: #fff;border-left: 1px solid #000;">
                    <p disabled={true} style="height: 23px !important;margin: inherit !important;border-color: transparent !important;" type="text"  class="form-control" id="safetyRequirement2" placeholder="" name="safetyRequirement2" style="height: auto;margin: inherit;padding: 0.175rem 0.75rem;">{{MarkAnyDocumentsRequired.textField13}}</p></td>
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <td style="text-align: center;border-left: 1px solid #000;">
              <div>
              <input  disabled={true} style="margin: 0 !important;" {% if MarkAnyDocumentsRequired.SafetyDataSheetMsds %} checked {% endif %}  class="form-check-input" type="checkbox" id="MarkAnyDocumentsRequired" name="MarkAnyDocumentsRequired" value="something" >
              </div>
            </td>
          ...
          <tr style="border-bottom: 1px solid #000;">
              ...
              <table style="width: 100%;">
                <tbody>
                  <tr>
                    ...
                    <td style="width: 30%;background: #fff;border-left: 1px solid #000;">
                    <p disabled={true} style="height: 23px !important;margin: inherit !important;border-color: transparent !important;" type="text" class="form-control" id="safetyRequirement2" placeholder="" name="safetyRequirement2" style="height: auto;margin: inherit;padding: 0.175rem 0.75rem;" >{{MarkAnyDocumentsRequired.textField14}}</p></td>
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <td style="text-align: center;border-left: 1px solid #000;">
              <div>
              <input  disabled={true} style="margin: 0 !important;" {% if MarkAnyDocumentsRequired.WasteStorage %} checked {% endif %}  class="form-check-input" type="checkbox" id="MarkAnyDocumentsRequired" name="MarkAnyDocumentsRequired" value="something" >
              </div>
            </td>
          ...
          <tr style="border-bottom: 1px solid #000;">
              ...
              <table style="width: 100%;">
                <tbody>
                  <tr>
                    ...
                    <td style="width: 30%;background: #fff;border-left: 1px solid #000;">
                    <p disabled={true} style="height: 23px !important;margin: inherit !important;border-color: transparent !important;" type="text"  class="form-control" id="safetyRequirement2" placeholder="" name="safetyRequirement2" style="height: auto;margin: inherit;padding: 0.175rem 0.75rem;">{{MarkAnyDocumentsRequired.textField15}}</p></td>
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <td style="text-align: center;border-left: 1px solid #000;">
              <div>
              <input  disabled={true} style="margin: 0 !important;" {% if MarkAnyDocumentsRequired.SketchDrawingPIdPfi %} checked {% endif %}  class="form-check-input" type="checkbox" id="MarkAnyDocumentsRequired" name="MarkAnyDocumentsRequired" value="something" >
              </div>
            </td>
          ...
          <tr style="border-bottom: 1px solid #000;">
              ...
              <table style="width: 100%;">
                <tbody>
                  <tr>
                    ...
                    <td style="width: 30%;background: #fff;border-left: 1px solid #000;">
                    <p disabled={true} style="height: 23px !important;margin: inherit !important;border-color: transparent !important;" type="text"  class="form-control" id="safetyRequirement2" placeholder="" name="safetyRequirement2" style="height: auto;margin: inherit;padding: 0.175rem 0.75rem;">{{MarkAnyDocumentsRequired.textField16}}</p></td>
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <td style="text-align: center;border-left: 1px solid #000;">
              <div>
              <input  disabled={true} style="margin: 0 !important;" {% if MarkAnyDocumentsRequired.VehicleEntryPermitInForbiddenAreas %} checked {% endif %}  class="form-check-input" type="checkbox" id="MarkAnyDocumentsRequired" name="MarkAnyDocumentsRequired" value="something" >
          ...
          <tr style="border-bottom: 1px solid #000;">
              ...
              <table style="width: 100%;">
                <tbody>
                  <tr>
                    ...
                    <td style="width: 30%;background: #fff;border-left: 1px solid #000;">
                    <p disabled={true} style="height: 23px !important;margin: inherit !important;border-color: transparent !important;" type="text"  class="form-control" id="safetyRequirement2" placeholder="" name="safetyRequirement2" style="height: auto;margin: inherit;padding: 0.175rem 0.75rem;" >{{MarkAnyDocumentsRequired.textField17}}</p></td>
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <td style="text-align: center;border-left: 1px solid #000;">
              <div>
              <input  disabled={true} style="margin: 0 !important;" {% if MarkAnyDocumentsRequired.DokumenExplosionProof %} checked {% endif %}  class="form-check-input" type="checkbox" id="MarkAnyDocumentsRequired" name="MarkAnyDocumentsRequired" value="something" >
              </div>
            </td>
          ...
          <tr style="border-bottom: 1px solid #000;">
              ...
              <table style="width: 100%;">
                <tbody>
                  <tr>
                    ...
                    <td style="width: 30%;background: #fff;border-left: 1px solid #000;">
                    <p disabled={true} style="height: 23px !important;margin: inherit !important;border-color: transparent !important;" type="text"  class="form-control" id="safetyRequirement2" placeholder="" name="safetyRequirement2" style="height: auto;margin: inherit;padding: 0.175rem 0.75rem;">{{MarkAnyDocumentsRequired.textField18}}</p></td>
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <td style="text-align: center;border-left: 1px solid #000;">
              <div>
              <input  disabled={true} style="margin: 0 !important;" {% if MarkAnyDocumentsRequired.JobSafetyAnalysis %} checked {% endif %}  class="form-check-input" type="checkbox" id="MarkAnyDocumentsRequired" name="MarkAnyDocumentsRequired" value="something" >
              </div>
            </td>
          ...
          <tr style="border-bottom: 1px solid #000;">
              ...
              <table style="width: 100%;">
                <tbody>
                  <tr>
                    ...
                    <td style="width: 30%;background: #fff;border-left: 1px solid #000;">
                    <p disabled={true} style="height: 23px !important;margin: inherit !important;border-color: transparent !important;" type="text"  class="form-control" id="safetyRequirement2" placeholder="" name="safetyRequirement2" style="height: auto;margin: inherit;padding: 0.175rem 0.75rem;" >{{MarkAnyDocumentsRequired.textField19}}</p></td>
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <td style="text-align: center;border-left: 1px solid #000;">
              <div>
              <input  disabled={true} style="margin: 0 !important;" {% if MarkAnyDocumentsRequired.RiskAssessments %} checked {% endif %}  class="form-check-input" type="checkbox" id="MarkAnyDocumentsRequired" name="MarkAnyDocumentsRequired" value="something" >
          ...
          <tr style="">
              ...
              <table style="width: 100%;">
                <tbody>
                  <tr>
                    ...
                    <td style="width: 30%;background: #fff;border-left: 1px solid #000;">
                    <p disabled={true} style="height: 23px !important;margin: inherit !important;border-color: transparent !important;" type="text" class="form-control" id="safetyRequirement2" placeholder="" name="safetyRequirement2" style="height: auto;margin: inherit;padding: 0.175rem 0.75rem;">{{MarkAnyDocumentsRequired.textField20}}</p></td>
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <td style="text-align: center;border-left: 1px solid #000;">
              <div>
              <input  disabled={true} style="margin: 0 !important;" {% if MarkAnyDocumentsRequired.Isolation %} checked {% endif %}  class="form-check-input" type="checkbox" id="MarkAnyDocumentsRequired" name="MarkAnyDocumentsRequired" value="something" >
              </div>
            </td>
          </tr>
          <tr style="border-bottom: 1px solid #000;border-top:1px solid #000;">
            ...
            <td style="text-align: center;border-left: 1px solid #000;">
              <div>
                <input disabled={true} style="margin: 0 !important;" class="form-check-input" type="checkbox" id="safetyRequirement23Yes" name="safetyRequirement23Yes" value="something" >
              </div>
            </td>
          ...
          <tr style="border-bottom: 1px solid #000;">
            ...
            <td style="text-align: center;border-left: 1px solid #000;">
              <div>
                <input disabled={true} style="margin: 0 !important;" class="form-check-input" type="checkbox" id="safetyRequirement24Yes" name="safetyRequirement24Yes" value="something" >
              </div>
            </td>
          ...
          <tr style="border-bottom: 1px solid #000;">
            ...
            <td style="text-align: center;border-left: 1px solid #000;">
              <div>
                <input disabled={true} style="margin: 0 !important;" class="form-check-input" type="checkbox" id="safetyRequirement25Yes" name="safetyRequirement25Yes" value="something" >
              </div>
            </td>
          ...
          <tr style="border-bottom: 1px solid #000;">
            ...
            <td style="text-align: center;border-left: 1px solid #000;">
              <div>
                <input disabled={true} style="margin: 0 !important;" class="form-check-input" type="checkbox" id="safetyRequirement26Yes" name="option1" value="something" >
              </div>
            </td>
          ...
          <tr style="border-bottom: 1px solid #000;">
            ...
            <td style="text-align: center;border-left: 1px solid #000;">
              <div>
                <input disabled={true} style="margin: 0 !important;" class="form-check-input" type="checkbox" id="safetyRequirement27Yes" name="safetyRequirement27Yes" value="something" >
              </div>
            </td>
          ...
          <tr style="border-bottom: 1px solid #000;">
            ...
            <td style="text-align: center;border-left: 1px solid #000;">
              <div>
                <input disabled={true} style="margin: 0 !important;" class="form-check-input" type="checkbox" id="safetyRequirement28Yes" name="safetyRequirement28Yes" value="something" >
              </div>
            </td>
              ...
              <table style="width: 100%;">
                <tbody>
                  <tr>
                    ...
                    <td style="width: 30%;background: #fff;border-left: 1px solid #000;">
                      <input disabled={true} style="height: 26px !important;margin: inherit !important;border-color: transparent !important;" type="text" class="form-control" id="safetyRequirement28" placeholder="" name="safetyRequirement28" style="height: auto;margin: inherit;padding: 0.175rem 0.75rem;">
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            <tbody>
              <tr style="border-bottom: 1px solid #000;">
                ...
                <td style="width: 5%;border-left: 1px solid #000;text-align: center;">
                  <p style="font-size: 10px;font-weight: 600;width: 100%;">Yes/ No</p>
                </td>
              ...
              <tr style="border-bottom: 1px solid #000;">
                ...
                <td style="border-left: 1px solid #000;text-align: center;width: 100%;">
                  <div>
                    <input  disabled={true} style="margin: 0 !important;" {% if SafetyRequirements.Emptyed %} checked {% endif %}  class="form-check-input" type="checkbox" id="safetyRequirementA6Experience" name="safetyRequirementA6Experience" value="something" >
                    </div>
                </td>
              ...
              <tr style="border-bottom: 1px solid #000;">
                ...
                <td style="border-left: 1px solid #000;text-align: center;">
                  <div>
                  <input  disabled={true} style="margin: 0 !important;" {% if SafetyRequirements.ReleasedFromPressure %} checked {% endif %}  class="form-check-input" type="checkbox" id="safetyRequirementA6Experience" name="safetyRequirementA6Experience" value="something" >
                  </div>
                </td>
              ...
              <tr style="border-bottom: 1px solid #000;">
                ...
                <td style="border-left: 1px solid #000;text-align: center;">
                  <div>
                  <input  disabled={true} style="margin: 0 !important;" {% if SafetyRequirements.Washed %} checked {% endif %}  class="form-check-input" type="checkbox" id="safetyRequirementA6Experience" name="safetyRequirementA6Experience" value="something" >
                  </div>
                </td>
              ...
              <tr style="border-bottom: 1px solid #000;">
                <td>
                  <p style="font-size: 10px;font-weight: 500;margin-left: 10px;">4. Streaming-out</p>
                </td>
                <td style="border-left: 1px solid #000;text-align: center;">
                  <div>
                  <input  disabled={true} style="margin: 0 !important;" {% if SafetyRequirements.Steamed %} checked {% endif %}  class="form-check-input" type="checkbox" id="safetyRequirementA6Experience" name="safetyRequirementA6Experience" value="something" >
                  </div>
                </td>
              ...
              <tr style="border-bottom: 1px solid #000;">
                  ...
                  <table style="width: 100%;">
                    <tbody>
                      <tr>
                        ...
                        <td style="width: 33.33%;">
                          <div style="display: flex;align-items: center; position: relative;">
                    <input disabled={true} {% if SafetyRequirements.Natural__hot == "0" %} checked {% endif %} {% if SafetyRequirements.Natural__hot == undefined %} checked {% endif %}  class="form-check-input" type="checkbox" id="new" name="new" value="something" >
                ...
                <td style="border-left: 1px solid #000;text-align: center;">
                  <div>
                  <input  disabled={true} style="margin: 0 !important;" {% if SafetyRequirements.PushedFlushedWithWater %} checked {% endif %}  class="form-check-input" type="checkbox" id="safetyRequirementA6Experience" name="safetyRequirementA6Experience" value="something" >
                  </div>
                </td>
              ...
              <tr style="border-bottom: 1px solid #000;">
                ...
                <td style="border-left: 1px solid #000;text-align: center;">
                  <div>
                  <input  disabled={true} style="margin: 0 !important;" {% if SafetyRequirements.Cooled %} checked {% endif %}  class="form-check-input" type="checkbox" id="safetyRequirementA6Experience" name="safetyRequirementA6Experience" value="something" >
                  </div>
                </td>
              ...
              <tr style="border-bottom: 1px solid #000;">
                ...
                <td style="border-left: 1px solid #000;text-align: center;">
                  <div>
                  <input  disabled={true} style="margin: 0 !important;" {% if SafetyRequirements.PurgedWithInertGas %} checked {% endif %}  class="form-check-input" type="checkbox" id="safetyRequirementA6Experience" name="safetyRequirementA6Experience" value="something" >
                  </div>
                </td>
              ...
              <tr style="border-bottom: 1px solid #000;">
                ...
                <td style="border-left: 1px solid #000;text-align: center;">
                  <div>
                  <input  disabled={true} style="margin: 0 !important;" {% if SafetyRequirements.CleanedOfDepositsScaleEntrapmentOfCombustibleMaterialsToxicCorrosive %} checked {% endif %}  class="form-check-input" type="checkbox" id="safetyRequirementA6Experience" name="safetyRequirementA6Experience" value="something" >
                  </div>
                </td>
              ...
              <tr style="border-bottom: 1px solid #000;">
                ...
                <td style="border-left: 1px solid #000;text-align: center;">
                  <div>
                  <input  disabled={true} style="margin: 0 !important;" {% if SafetyRequirements.Ventilation %} checked {% endif %}  class="form-check-input" type="checkbox" id="safetyRequirementA6Experience" name="safetyRequirementA6Experience" value="something" >
                  </div>
                </td>
              </tr>
              <tr style="border-bottom: 1px solid #000;">
                ...
                <td style="border-left: 1px solid #000;text-align: center;">
                  <div>
                  <input  disabled={true} style="margin: 0 !important;" {% if SafetyRequirements.FireExtinguisher%} checked {% endif %}  class="form-check-input" type="checkbox" id="safetyRequirementA6Experience" name="safetyRequirementA6Experience" value="something" >
                  </div>
                </td>
              </tr>
              <tr style="border-bottom: 1px solid #000;">
                <td>
                  <p style="font-size: 10px;font-weight: 500;margin-left: 10px;">11. Erect sign and barrier</p>
                </td>
                <td style="border-left: 1px solid #000;text-align: center;">
                  <div>
                  <input  disabled={true} style="margin: 0 !important;" {% if SafetyRequirements.ErectSignAndBarrier %} checked {% endif %}  class="form-check-input" type="checkbox" id="safetyRequirementA6Experience" name="safetyRequirementA6Experience" value="something" >
                  </div>
                </td>
              </tr>
              <tr style="border-bottom: 1px solid #000;">
                ...
                <td style="border-left: 1px solid #000;text-align: center;">
                  <div>
                  <input  disabled={true} style="margin: 0 !important;" {% if SafetyRequirements.ControlWorkingHour%} checked {% endif %}  class="form-check-input" type="checkbox" id="safetyRequirementA6Experience" name="safetyRequirementA6Experience" value="something" >
                  </div>
                </td>
              </tr>
              <tr style="border-bottom: 1px solid #000;">
                <td>
                  <p style="font-size: 10px;"><b>B. Isolation Requirment (For Simple Isolation, Use This Checkbox)</b>
                  <input  disabled={true} style="margin: 0 !important;" {% if SafetyRequirements.bIsolationRequirment %} checked {% endif %} class="form-check-input" type="checkbox" id="safetyRequirementA9No" name="safetyRequirementA9No" value="something" >
                  </p>
                </td>
              ...
              <tr style="border-bottom: 1px solid #000;">
                ...
                <td style="border-left: 1px solid #000;text-align: center;">
                  <div>
                  <input  disabled={true} style="margin: 0 !important;" {% if SafetyRequirements.Mechanical %} checked {% endif %}  class="form-check-input" type="checkbox" id="safetyRequirementA6Experience" name="safetyRequirementA6Experience" value="something" >
                  </div>
                </td>
              ...
              <tr style="border-bottom: 1px solid #000;">
                ...
                <td style="border-left: 1px solid #000;text-align: center;">
                  <div>
                  <input  disabled={true} style="margin: 0 !important;" {% if SafetyRequirements.Electricity %} checked {% endif %}  class="form-check-input" type="checkbox" id="safetyRequirementA6Experience" name="safetyRequirementA6Experience" value="something" >
                  </div>
                </td>
              ...
              <tr style="border-bottom: 1px solid #000;">
                <td>
                  <p style="font-size: 10px;"><b>C. Other Safeguards</b></p>
                </td>
                <td style="margin: 0;">&nbsp;</td>
                <td style="margin: 0;">&nbsp;</td>
              </tr>
              <tr style="border-bottom: 1px solid #000;">
                ...
                <td style="border-left: 1px solid #000;text-align: center;">
                  <div>
                  <input  disabled={true} style="margin: 0 !important;" {% if SafetyRequirements.AllSewerDrainsAndFittingsAtADistanceOf15MetersFromTheSiteWorkHasBeenClosed %} checked {% endif %}  class="form-check-input" type="checkbox" id="safetyRequirementA6Experience" name="safetyRequirementA6Experience" value="something" >
                  </div>
                </td>
              ...
              <tr style="border-bottom: 1px solid #000;">
                ...
                <td style="border-left: 1px solid #000;text-align: center;">
                  <div>
                  <input  disabled={true} style="margin: 0 !important;" {% if SafetyRequirements.SecureAreaFromFlammableMaterialLeakage %} checked {% endif %}  class="form-check-input" type="checkbox" id="safetyRequirementA6Experience" name="safetyRequirementA6Experience" value="something" >
                  </div>
                </td>
              ...
              <tr style="border-bottom: 1px solid #000;">
                <td>
                  <p style="font-size: 10px;font-weight: 500;margin-left: 10px;">3. Stand by fire extinguisher (APAR, Water Spray, Fire Blanket)</p>
                </td>
                <td style="border-left: 1px solid #000;text-align: center;">
                  <div>
                  <input  disabled={true} style="margin: 0 !important;" {% if SafetyRequirements.StandByFireExtinguishersAparWaterSprayFireBlanket %} checked {% endif %}  class="form-check-input" type="checkbox" id="safetyRequirementA6Experience" name="safetyRequirementA6Experience" value="something" >
                  </div>
                </td>
              ...
              <tr style="border-bottom: 1px solid #000;">
                ...
                <td style="border-left: 1px solid #000;text-align: center;">
                  <div>
                  <input  disabled={true} style="margin: 0 !important;" {% if SafetyRequirements.ExplosionProofEquipment %} checked {% endif %}  class="form-check-input" type="checkbox" id="safetyRequirementA6Experience" name="safetyRequirementA6Experience" value="something" >
                  </div>
                </td>
              ...
              <tr style="border-bottom: 1px solid #000;">
                <td>
                  <p style="font-size: 10px;font-weight: 500;margin-left: 10px;">5. Electric lighting with voltage (Low, High)</p>
                </td>
                <td style="border-left: 1px solid #000;text-align: center;">
                  <div>
                  <input  disabled={true} style="margin: 0 !important;" {% if SafetyRequirements.ElectricLightingWithVoltageLowHigh %} checked {% endif %}  class="form-check-input" type="checkbox" id="safetyRequirementA6Experience" name="safetyRequirementA6Experience" value="something" >
                  </div>
                </td>
              ...
              <tr style="border-bottom: 1px solid #000;">
                ...
                <td style="border-left: 1px solid #000;text-align: center;">
                  <div>
                  <input  disabled={true} style="margin: 0 !important;" {% if SafetyRequirements.ThePowerBreakerHasBeenGrounded %} checked {% endif %}  class="form-check-input" type="checkbox" id="safetyRequirementA6Experience" name="safetyRequirementA6Experience" value="something" >
                  </div>
                </td>
              ...
              <tr style="border-bottom: 1px solid #000;">
                ...
                <td style="border-left: 1px solid #000;text-align: center;">
                  <div>
                  <input  disabled={true} style="margin: 0 !important;" {% if SafetyRequirements.TemporaryLightingAccordingToClassificationAndInGoodCondition %} checked {% endif %}  class="form-check-input" type="checkbox" id="safetyRequirementA6Experience" name="safetyRequirementA6Experience" value="something" >
                  </div>
                </td>
              ...
              <tr style="border-bottom: 1px solid #000;">
                <td>
                  <p style="font-size: 10px;font-weight: 500;margin-left: 10px;">8. Stand by </p>
                  <table style="width: 100%;">
                    <tbody>
                      <tr>
                        <td style="width: 25%;padding-left: 10px;">
                          <div style="display: flex;align-items: center; position: relative;">
                            ...
                            <label class="form-check-label"><p style="font-size: 10px;">Standby Fireman</p></label>
                          </div>
                        </td>
                        <td style="width: 25%;">
                          <div style="display: flex;align-items: center; position: relative;">
                        ...
                        <td style="width: 25%;">
                          <div style="display: flex;align-items: center; position: relative;">
                            <input disabled={true} style="margin: 0 !important;" {% if SafetyRequirements.rescuer %} checked {% endif %} class="form-check-input" type="checkbox" id="safetyRequirementA6Experience" name="safetyRequirementA6Experience" value="something" >
                ...
                <td style="border-left: 1px solid #000;text-align: center;">
                  <div>
                  <input  disabled={true} style="margin: 0 !important;" {% if SafetyRequirements.StandBy %} checked {% endif %}  class="form-check-input" type="checkbox" id="safetyRequirementA6Experience" name="safetyRequirementA6Experience" value="something" >
                  </div>
                </td>
              ...
              <tr style="border-bottom: 1px solid #000;">
                <td>
                  <p style="font-size: 10px;font-weight: 500;margin-left: 10px;">9. All welding equipment has been grounded placed in</p>
                </td>
                <td style="border-left: 1px solid #000;text-align: center;">
                  <div>
                  <input  disabled={true} style="margin: 0 !important;" {% if SafetyRequirements.AllWeldingEquipmentHasBeenPlacedInASafePositionBondedAndGrounded %} checked {% endif %}  class="form-check-input" type="checkbox" id="safetyRequirementA6Experience" name="safetyRequirementA6Experience" value="something" >
                  </div>
                </td>
              ...
              <tr style="border-bottom: 1px solid #000;">
                <td>
                  <p style="font-size: 10px;font-weight: 500;margin-left: 10px;">10. A safe Work position, must be bonded wetted and continue with water</p>
                </td>
                <td style="border-left: 1px solid #000;text-align: center;">
                  <div>
                  <input  disabled={true} style="margin: 0 !important;" {% if SafetyRequirements.TheWorkMustBeConstantlyMoistenedWithWater %} checked {% endif %}  class="form-check-input" type="checkbox" id="safetyRequirementA6Experience" name="safetyRequirementA6Experience" value="something" >
                  </div>
                </td>
              ...
              <tr style="border-bottom: 1px solid #000;">
                <td>
                  <p style="font-size: 10px;font-weight: 500;margin-left: 10px;">11. Welding cutting and all machines have been placed in a safe place </p>
                </td>
                <td style="border-left: 1px solid #000;text-align: center;">
                  <div>
                  <input  disabled={true} style="margin: 0 !important;" {% if SafetyRequirements.WeldingEquipmentCuttingToolsAndAllMachinesHaveBeenPlacedInASafePlace %} checked {% endif %}  class="form-check-input" type="checkbox" id="safetyRequirementA6Experience" name="safetyRequirementA6Experience" value="something" >
                  </div>
                </td>
              ...
              <tr style="border-bottom: 1px solid #000;">
                <td>
                  <p style="font-size: 10px;font-weight: 500;margin-left: 10px;">12. Auxiliary tools, ladders, scaffolding, air propulsion, lighting cables, tools, (tools), diesel engines, compressors, blowers meet the requirements</p>
                </td>
                <td style="border-left: 1px solid #000;text-align: center;">
                  <div>
                  <input  disabled={true} style="margin: 0 !important;" {% if SafetyRequirements.AuxiliaryToolsLaddersScaffoldingAirPropulsionLightingCablesToolsToolsDieselEnginesCompressorsBlowersMeetTheRequirements1 %} checked {% endif %}  class="form-check-input" type="checkbox" id="safetyRequirementA6Experience" name="safetyRequirementA6Experience" value="something" >
                  </div>
                </td>
              ...
              <tr style="border-bottom: 1px solid #000;">
                ...
                <td style="border-left: 1px solid #000;text-align: center;">
                  <div>
                  <input  disabled={true} style="margin: 0 !important;" {% if SafetyRequirements.AllMachinesMustBePlacedInASafeLocation %} checked {% endif %}  class="form-check-input" type="checkbox" id="safetyRequirementA6Experience" name="safetyRequirementA6Experience" value="something" >
                  </div>
                </td>
              ...
              <tr style="border-bottom: 1px solid #000;">
                ...
                <td style="border-left: 1px solid #000;text-align: center;">
                  <div>
                  <input  disabled={true} style="margin: 0 !important;" {% if SafetyRequirements.EvacuationRoutesArePrepared %} checked {% endif %}  class="form-check-input" type="checkbox" id="safetyRequirementA6Experience" name="safetyRequirementA6Experience" value="something" >
                  </div>
                </td>
                
              </tr>
              <tr style="" class="gastest">
                ...
                <td style="border-left: 1px solid #000;text-align: center;">
                  <div>
                  <input  disabled={true} style="margin: 0 !important;" {% if SafetyRequirements.GasTestEvery %} checked {% endif %}  class="form-check-input" type="checkbox" id="safetyRequirementA6Experience" name="safetyRequirementA6Experience" value="something" >
                  </div>
                </td>
      ...
      <tr style="background: #feff99;">
        ...
        <td style="padding: 0px;">
          <div style="display: flex;align-items: center; position: relative;">
            ...
            <label class="form-check-label"><p style="font-size: 10px;font-weight: 500;margin: 0;">Cover the sewer, drain and sump with fire blanket</p></label>
          </div>
        </td>
        <td style="padding: 0px;">
          <div style="display: flex;align-items: center; position: relative;">
    ...
    <tbody>
      ...
      <tr style="border-bottom: 1px solid #000;">
        <td style="background: #feff99;padding: 0 0.5rem;">
          ...
          <p style="font-size: 10px;font-weight: 500;">5. The nearest Assembly Point is at. {{SpecialInstruction.textField}}</p>
          <p style="font-size: 10px;font-weight: 500;">6.Return this SIKA HOT to the Authorized Operations Officer Area Athurity(GSI).</p>
          <p style="font-size: 10px;font-weight: 500;">7. In case of an emergency, call tel. {{SpecialInstruction.textField1}}</p>
      ...
      <tr style="border-bottom: 1px solid #000;">
        <td colspan="4" style="padding: 0 0.5rem;">
          <p style="margin: 0;font-size: 12px;"><b>Section 3: Issuance Of Work licence by Area Authority (GSI) Officer</b></p>
        </td>
      </tr>
      <tr style="border-bottom: 1px solid #000;">
        <td style="background: #feff99;padding: 0 0.5rem;">
          ...
          <div class="inline-flex">
            <p style="font-size: 10px;font-weight: 500;padding-top: 15px;">Name: {{AuthorizationAcceptance.name6
            }}</p>
          </div>
        </td>
      </tr>
      ...
      <tr style="border-bottom: 1px solid #000;" >
        <td colspan="4" style="padding: 0 0.5rem;">
          <p style="margin: 0px;font-size: 12px;"><b>Section 4: Receipt Of Work Permit By Work Executor (Permforming Authority (Ahil Teknik))</b></p>
        </td>
      </tr>
      <tr style="border-bottom: 1px solid #000;">
        <td style="background: #ccffcc;padding: 0 0.5rem;">
          <p style="font-size: 10px;"><b>Authorized Technician</b></p>
          <p style="font-size: 10px;font-weight: 500;">I understand and adhere to all precautions and Good House Keeping before and during the work is performed and will contact the office authorized operation when work begins.</p>
          <div class="inline-flex">
            <p style="font-size: 10px;font-weight: 500;padding-top: 15px;">Name: {{AuthorizationAcceptance.name10
            }}</p>
          </div>
        </td>
      </tr>
      <tr style="border-bottom: 1px solid #000;">
        <td colspan="4" style="padding: 0 0.5rem;">
          <p style="margin: 0px;font-size: 12px;"><b>Section 5: Handover By The Permforming Authority (Ahil Teknik) (Signed By Permforming Authority (Ahil Teknik) After The Work Is Completed)</b></p>
        </td>
      </tr>
      <tr style="border-bottom: 1px solid #000;">
        <td style="background: #ccffcc;padding: 0 0.5rem;">
          ...
          <div class="inline-flex">
            <p style="font-size: 10px;font-weight: 500;padding-top: 15px;">Name: {{AuthorizationAcceptance.name11
            }}</p>
          </div>
        </td>
      </tr>
      ...
      <tr style="border-bottom: 1px solid #000;">
        <td style="background: #feff99;padding: 0 0.5rem;">
          ...
          <div class="inline-flex">
            <p style="font-size: 10px;font-weight: 500;padding-top: 15px;">Name: {{AuthorizationAcceptance.name12}}</p>
          </div>
        </td>
      </tr>
    </tbody>
    ...
    <tbody>
      ...
      <tr style="border-bottom: 0.5px solid #000;">
        {% for item in data.data %}
          ...
          {%- endif -%}
          <td style="padding: 0px;border-left: 0.5px solid #000; border-right: 0.5px solid #000;">
            <p style="font-size: 10px;font-weight: 500;padding-left: 10px;">{{item.lel}}</p>
          </td>
        {% endfor %}
      </tr>
      <tr style="border-bottom: 0.5px solid #000;">
        {% for item in data.data %}
          ...
          {%- endif -%}
          <td style="padding: 0px;border-left: 0.5px solid #000; border-right: 0.5px solid #000;">
            <p style="font-size: 10px;font-weight: 500;padding-left: 10px;">{{item.oxy}}</p>
          </td>
        {% endfor %}
      </tr>
      ...
      <tr style="border-bottom: 0.5px solid #000;">
        {% for item in data.data %}
          ...
          {%- endif -%}
          <td style="padding: 0px;border-left: 0.5px solid #000; border-right: 0.5px solid #000;">
            <p style="font-size: 10px;font-weight: 500;padding-left: 10px;">{{item.h2s}}</p>
          </td>
        {% endfor %}
      </tr>
      <tr style="border-bottom: 0.5px solid #000;">
        {% for item in data.data %}
          {%- if forloop.index0 == 0 -%}
          <td style="padding: 0px;padding-left: 10px;background: #feff99;margin-left: 10px;">
            <p style="font-size: 10px;font-weight: 500;">Others</p>
          </td>
          {%- endif -%}
          <td style="padding: 0px;border-left: 0.5px solid #000; border-right: 0.5px solid #000;">
            <p style="font-size: 10px;font-weight: 500;padding-left: 10px;">{{item.others}}</p>
          </td>
        {% endfor %}
      </tr>
      {% endfor %}
