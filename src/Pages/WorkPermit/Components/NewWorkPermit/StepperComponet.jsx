  ...
  return (
    <Stepper alternativeLabel activeStep={stepperValue} connector={<QontoConnector />}>
      {stepperData.map((label, index) => {
        return (label.statusId === 5 && workPermitData.status === 7) ||
          (label.statusId === 5 && workPermitData.status === 8) ||
          (label.statusId === 19 && workPermitData.status === 12) ||
          (label.statusId === 19 && workPermitData.status === 23) ||
          (label.statusId === 5 && workPermitData.status === 9) ? (
